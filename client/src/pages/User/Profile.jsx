...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    const fetchEarnings = async () => {
      try {
        const response = await fetch("https://nftrade-marketplace.vercel.app/nft/earnings", {
          method: "GET",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://nftrade-marketplace.vercel.app/user/update", {
        method: "PUT",
        credentials: "include",
